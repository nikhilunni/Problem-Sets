  ...
  \item [11.2]
    ...
    \begin{itemize}
      ...
      \item [(c)] For each sequence, give its lim sup and lim inf.\\\\
        ...
        For $(a_n)$, regardless of how large $N$ is, the sup is $1$, since the only possible values of $a_{n>N}$ are $-1$ and $1$, with an arbitrarily large $N$. So the lim sup is $1$. Similarly, the lim inf is $-1$.\\\\
