 ...
 */
gradientColorPicker::gradientColorPicker( RGBAPixel fadeCol1, 
		RGBAPixel fadeCol2, int rad, int X, int Y ) {
	fadeColor1 = fadeCol1;
	fadeColor2 = fadeCol2;
	radius = rad;
	centerX = X;
...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
	...
	{
		color.red = fadeColor1.red - floor(d * fadeColor1.red / radius)
						+ floor(d * fadeColor2.red / radius);
		color.green = fadeColor1.green - floor(d * fadeColor1.green / radius)
                        + floor(d * fadeColor2.green / radius);
		color.blue = fadeColor1.blue - floor(d * fadeColor1.blue / radius)
                        + floor(d * fadeColor2.blue / radius);
	}
	return color;
}
